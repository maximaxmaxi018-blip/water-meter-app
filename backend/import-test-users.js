...
const db = new sqlite3.Database(dbPath, (err) => {
  if (err) {
    ...
    // Тестовые пользователи с лицевыми счетами от 100100 до 100130
    const testUsers = [
      ...
      { accountNumber: '100103', fullName: 'Миниугулов Александр Равилевич', address: 'ПИТКЯРАНТА, ул. ПОВЕДЫ, д. 9, кв. 58', phone: '+7 921 456-78-90', email: 'mini103@example.com' },
      ...
      { accountNumber: '100116', fullName: 'Лавровцев Сергей Анатольевич', address: 'Д. РАЙМЛЯ, ул. ЦЕНТРАЛЬНАЯ, д. 18, кв. 4', phone: '+7 921 111-11-26', email: 'lavrovtsev116@example.com' },
      ...
      { accountNumber: '100129', fullName: 'Лапина Марина Юрьевна', address: 'п. САЛМИ, ул. ЛЕСНАЯ, д. 12, кв. 11', phone: '+7 921 456-78-90', email: 'lapina.m@example.com' },
      { accountNumber: '100130', fullName: 'Иван Петров', address: 'г. ПИТКЯРАНТА, ул. ЛЕНИНА, 25', phone: '+7 921 123-45-67', email: 'ivan.petrov@example.com' },
    ];
    ...
    testUsers.forEach(user => {
      db.run(
        ...
        (err) => {
          ...
          if (imported + failed === testUsers.length) {
